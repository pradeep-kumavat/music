    ...
    <div className="p-12 bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center">
          <h2 className="font-bold text-base text-teal-600 tracking-wide uppercase">FEATURED WEBINAR</h2>
          <p className="mt-3 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">Enhance Your Musical Journey</p>
        </div>
